      ...
      <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4 text-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          <button
            ...
            className="w-full py-3 bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-hover)] text-white rounded-xl font-bold flex items-center justify-center gap-2 cursor-pointer shadow-md"
          >
