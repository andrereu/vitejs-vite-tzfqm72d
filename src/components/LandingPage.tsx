    ...
    <div className="space-y-16 pb-16 print:hidden">
        ...
        <div className="bg-gradient-to-b from-[#2E482A] via-[#233820] to-[#172515] text-white p-8 md:p-14 rounded-3xl shadow-2xl space-y-6 relative border border-[#3D5C38]">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center items-center">
            ...
            <button 
              ...
              className="w-full sm:w-auto px-6 py-3.5 bg-white/10 hover:bg-white/20 text-white rounded-2xl font-bold text-xs border border-white/20 flex items-center justify-center gap-2 transition-all cursor-pointer"
            >
      ...
      <div className="max-w-5xl mx-auto px-4">
        <AdBanner 
          ...
          placeholderSubtitle="Produtos essenciais para maternidade, enxoval e cuidados com o recém-nascido."
        />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-xs space-y-3">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              A gestante envia a foto da ecografia ou exame de sangue e a IA Gemini extrai os dados automaticamente e gera um resumo acolhedor para a mãe.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-xs space-y-3">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Gráfico automático de Ganho Ponderal Gestacional nos padrões do Ministério da Saúde com cálculo do IMC e faixas de recomendação.
            </p>
          </div>
