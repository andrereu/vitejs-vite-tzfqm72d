          ...
          <div className="bg-white rounded-3xl max-w-sm w-full p-6 shadow-2xl space-y-4 text-gray-800">
            ...
            <div className="space-y-2">
              <p className="text-[10px] text-gray-500 text-center">
                Entre com a conta Google cadastrada no seu consultório — não precisa de senha.
              </p>
              <button
                type="button"
                onClick={props.handleGoogleDoctorLogin}
                className="w-full py-2.5 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold rounded-2xl flex items-center justify-center gap-2 shadow-xs cursor-pointer text-xs transition-all"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
            ...
            <div className="flex items-center gap-2 py-1">
              ...
              <span className="text-[10px] text-gray-400 font-bold uppercase">ou com e-mail e senha</span>
              <div className="h-px bg-gray-200 flex-1" />
            </div>
