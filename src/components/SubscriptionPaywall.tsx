      ...
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl space-y-6 text-gray-800 text-center">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full py-3.5 bg-[#2E482A] hover:bg-[#233820] disabled:opacity-60 text-white rounded-2xl font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all cursor-pointer"
          >
            {isCreatingCheckout ? (
